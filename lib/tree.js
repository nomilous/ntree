...
Tree.prototype._detachSource = function(source) {
  ...
  if (originalSource.type == SourceType.DIRECTORY) {
    this._detachDirectory(originalSource);
  } else {
    this._detachFile(originalSource);
  }

  // console.log('detached', originalSource.patch);

}

Tree.prototype._detachDirectory = function(source) {
  ...
  var vertex = vref.__;
  return vertex.unloadSource(source);
}

Tree.prototype._detachFile = function(source) {
