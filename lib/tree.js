...
function Tree(config) {
  ...
  // Hide EventEmitter internals to keep tree object clean for serialization
...
/**
 * ### ._notify(vertex, change)
 *
 * Notifies of change in tree.
 *
 * @api public
 * @param {Vertex} vertex
 * @param {{op: String, key: String, value: Object, oldValue: Object}}
 *
 */
