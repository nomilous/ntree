...
Tree.prototype._assemble = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var watcher, loader;
    var skip = true; // skip mout dir // TODO: use first event?
    ...
    watcher.on('ready', function() {
      tree._emitter.removeListener('$load', loader);
      resolve(tree);
    });
  ...
  //xxx   var emitter = _this._emitter;
  //xxx   var filename = _this._opts.mount;

  //xxx   _this._tools.readdirRecurseAsync(emitter, filename).then(function(dir) {
  //xxx     resolve(_this);
  //xxx   }).catch(reject);
  //xxx });
}
