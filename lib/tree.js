...
function Tree(opts) {
  ...
  if (typeof opts.agent.scanInterval !== 'number') {
    opts.agent.scanInterval = 20;
  }
  ...
  opts.patch.noop = typeof opts.patch.noop === 'boolean' ? opts.patch.noop : false;
  opts.patch.previous = typeof opts.patch.previous === 'boolean' ? opts.patch.previous : false;
