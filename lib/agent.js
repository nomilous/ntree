...
var debugs = require('./debugs')('ntree:agent', ['getSync', 'setSync', 'watch']);
var getSync = debugs.getSync;
var setSync = debugs.setSync;
var watch = debugs.watch;
...
function Agent(vertex, locus, object, value, route) {
  ...
  this.logger = vertex._tree._tools.logger;
...
Agent.prototype.watch = function() {
  ...
  this.interval = setInterval(function() {
    ...
    Object.keys(_this.value).forEach(function(key) {
