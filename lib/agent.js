...
var debugs = require('./debugs')('ntree:agent', ['new', 'getSync', 'setSync', 'activate', 'created', 'destroyed']);
...
Agent.prototype.activate = function() {
  ...
  activate('starting as %s', this.constructor.name);
...
Agent.prototype.created = function(key) {
  ...
  return this.vertex.created(key, this);
