    ...
    promise.then(function(list) {
      ...
      list.forEach(function(vertexInfo) {
        ...
        if (vertexInfo.stat.isDirectory()) {
          ...
          vertexSets.directory = vertexSets.directory || [];
          vertexSets.directory.push(vertexInfo);
          return;

        }

        if (vertexInfo.name.match(/\.js$/)) {

          vertexSets.javascript = vertexSets.javascript || [];
          vertexSets.javascript.push(vertexInfo);
          return;
      ...
      debug(
        '(%s) directories: %d, javascripts: %s',
        name,
        vertexSets.directory.length,
        vertexSets.javascript.length
      );
