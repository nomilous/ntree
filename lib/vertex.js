...
Vertex.prototype.onCreatedKey = function(key, agent) {
  ...
  if (serializer.constructor.name !== 'Directory') {
    change.op = 'update';
    serializer.encodeSync(this, change);
    this._tree._notify(this, change);
    return;
  }
...
Vertex.prototype.onDestroyedKey = function(key, agent, oldValue) {
